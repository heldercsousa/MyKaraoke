...
This document provides the official, validated SVG icons for the application. Each icon has a direct download link to the official Google Material Symbols library to ensure correct rendering and a consistent user experience.
...
- [**Download `music_note_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/music_note/24px.svg)
- [**Download `music_note_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/music_note/24px.svg)

### Musics Catalog
- **Symbol Name:** `library_music`
- **Rationale:** A collection or repertoire of songs.
- [**Download `library_music_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/library_music/24px.svg)
- [**Download `library_music_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/library_music/24px.svg)

### Venues (Karaoke)
- **Symbol Name:** `nightlife`
- **Rationale:** Captures the social, bar, and event atmosphere of a karaoke venue.
- [**Download `nightlife_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/nightlife/24px.svg)
- [**Download `nightlife_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/nightlife/24px.svg)

### Events
- **Symbol Name:** `event`
- **Rationale:** Universal symbol for a scheduled event or a specific date/occasion.
- [**Download `event_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/event/24px.svg)
- [**Download `event_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/event/24px.svg)

### Singers
- **Symbol Name:** `mic`
- **Rationale:** Defines the participant by their primary tool and action: singing.
- [**Download `mic_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/mic/24px.svg)
- [**Download `mic_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/mic/24px.svg)

### Event Queue
- **Symbol Name:** `format_list_numbered`
- **Rationale:** Represents a numbered, ordered list of singers for the event.
- [**Download `format_list_numbered_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/format_list_numbered/24px.svg)
- [**Download `format_list_numbered_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/format_list_numbered/24px.svg)
...
- [**Download `graphic_eq_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/graphic_eq/24px.svg)
- [**Download `graphic_eq_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/graphic_eq/24px.svg)

### Sung (Turn Completed)
- **Symbol Name:** `check_circle`
- **Rationale:** A checkmark inside a circle is a universally recognized symbol for a completed task.
- [**Download `check_circle_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/check_circle/24px.svg)
- [**Download `check_circle_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/check_circle/24px.svg)

### Declined / Skipped Turn
- **Symbol Name:** `block`
- **Rationale:** A clear and unambiguous way to show that a singer declined their turn.
- [**Download `block_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/block/24px.svg)
- [**Download `block_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/block/24px.svg)
...
- [**Download `account_circle_outlined.svg`**](https://fonts.gstatic.com/s/i/materialiconsoutlined/account_circle/24px.svg)
- [**Download `account_circle_filled.svg`**](https://fonts.gstatic.com/s/i/materialicons/account_circle/24px.svg)
